...
export class Migration20221227184853 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'create table "email_verification" ("user_id" int not null, "verified_at" timestamptz(0) not null, "last_sent" timestamptz(0) null, constraint "email_verification_pkey" primary key ("user_id"));',
    );
